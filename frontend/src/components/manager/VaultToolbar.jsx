...
const VaultToolbar = ({
  ...
  return (
    <>
      <div className="px-3 py-4 sm:px-5 sm:py-5 md:px-7 border-b border-green-100 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-800 tracking-tight">Password Vault</h1>
        ...
        <div className="grid grid-cols-2 sm:flex gap-2 w-full md:w-auto">
          <button
            ...
            className="w-full sm:w-auto rounded-xl bg-slate-100 hover:bg-slate-200 disabled:bg-slate-200 disabled:text-slate-500 disabled:cursor-not-allowed px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-slate-700 transition-colors"
          >
          ...
          <button
            type="button"
            onClick={onAdd}
            className="w-full sm:w-auto rounded-xl bg-green-700 hover:bg-green-600 px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-white transition-colors"
          >
            Add Password
          </button>
        </div>
      ...
      <div className="px-3 pt-3 sm:px-5 md:px-7 shrink-0">
